...
Цель текущего mechanical stage: **собрать временный hoverboard drive module без ножа, жёстко закрепить механику, проверить kill switch и первую езду на низком режиме**.
...
- решение MVP зафиксировано в `docs/mechanical-mvp-drive-module.md`;
- мотор-колёса не вынимать из родного алюминиевого шасси ховерборда;
- ховерборд собрать как закрытый drive module: АКБ слева, электроника справа;
- две половины ховера связать нижней фанерой/плитой и болтами;
- к Greenworks стыковать целиком как задний приводной мост вместо штатных задних колёс;
- передние колёса Greenworks оставить;
- нож Greenworks физически не подключать.
