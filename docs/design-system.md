...
- Hero/art/story images хранить source-grade PNG рядом с web delivery WebP.
- WebP для крупных атмосферных AI-рендеров экспортировать не ниже `cwebp -q 96 -m 6 -af`.
- Не гнаться за 150-250 KB на полноэкранных картинках: туман, зерно, ржавчина и мягкий свет разваливаются первыми.
- Для hero следующего поколения целиться в 2400-3000 px по ширине, если исходник доступен или картинка перегенерируется.
- PNG использовать как source asset, WebP как delivery asset.
